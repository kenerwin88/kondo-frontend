            ...
            <div class="col px-0">
              <div class="row">
                <div class="col-lg-12">
                  ...
                  <p class="lead  text-white">Not all who code are tidy, but with Kondo.io, they will be.</p>
                  <div class="embed-responsive embed-responsive-16by9">
                    <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/v7ZcZfGBFcU?rel=0" allowfullscreen></iframe>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="row row-grid align-items-center">
            ...
            <div class="col-md-6 order-md-1">
              <div class="pr-md-5">
                ...
                <h3>Features</h3>
                <p>Here is a high level overview of what Kondo.io can do for your organization.</p>
                <ul class="list-unstyled mt-5">
                  <li class="py-2">
                    <div class="d-flex align-items-center">
                      ...
                      <div>
                        <h6 class="mb-0">Enforce standardized repo structures.</h6>
                      </div>
                    </div>
                  </li>
                  <li class="py-2">
                    <div class="d-flex align-items-center">
                      ...
                      <div>
                        <h6 class="mb-0">Choose from a curated list of best practices.</h6>
                      </div>
                    </div>
                  </li>
                  <li class="py-2">
                    <div class="d-flex align-items-center">
                      ...
                      <div>
                        <h6 class="mb-0">Start on the right foot, scaffolding for new code.</h6>
                      </div>
                    </div>
                  </li>
                  <li class="py-2">
                    <div class="d-flex align-items-center">
                      ...
                      <div>
                        <h6 class="mb-0">Clean up legacy code with ratcheting.</h6>
                      </div>
                    </div>
                  </li>
                  <li class="py-2">
                    <div class="d-flex align-items-center">
                      ...
                      <div>
                        <h6 class="mb-0">Enforce tool/language standardization.</h6>
                      </div>
                    </div>
                  </li>
                  <li class="py-2">
                    <div class="d-flex align-items-center">
                      ...
                      <div>
                        <h6 class="mb-0">In some cases, we can clean up your repos for you!</h6>
                      </div>
                    </div>
                  </li>
                </ul>
            ...
            <div class="col-md-6">
              <div class="card bg-default shadow border-0">
                ...
                <blockquote class="card-blockquote">
                  ...
                  <p class="lead text-italic text-white">The Arctic Ocean freezes every winter and much of the sea-ice
                    then thaws every summer, and that process will continue whatever happens.</p>
                </blockquote>
              </div>
            </div>
            <div class="col-md-6">
              <div class="pl-md-5">
                ...
                <h3>Our customers</h3>
                <p class="lead">Don't let your uses guess by attaching tooltips and popoves to any element. Just make
                  sure you enable them first via JavaScript.</p>
                <p>The kit comes with three pre-built pages to help you get started faster. You can change the text and
        ...
        <div class="container pt-lg pb-300">
          <div class="row text-center justify-content-center">
            <div class="col-lg-10">
              ...
              <p class="lead text-white">According to the National Oceanic and Atmospheric Administration, Ted, Scambos,
                NSIDClead scentist, puts the potentially record low maximum sea ice extent tihs year down to low
                ice.</p>
            </div>
          </div>
          ...
          <div class="row row-grid justify-content-center">
            <div class="col-lg-8 text-center">
              ...
              <p class="lead">Cause if you do, it can be yours for FREE. Hit the button below to navigate to Creative
                Tim where you can find the Design System in HTML. Start a new project or give an old Bootstrap project a
                new look!</p>
              <div class="btn-wrapper">
                <a href="https://www.creative-tim.com/product/argon-design-system" class="btn btn-primary mb-3 mb-sm-0">Download
                  HTML</a>
              </div>
